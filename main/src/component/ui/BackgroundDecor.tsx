...
const MARKS: Mark[] = [
  ...
  // more coding
  { s: "try{}", top: 2, left: 50, size: 1.1, rot: -4, op: 0.1 },
  { s: "catch", top: 96, left: 48, size: 1.1, rot: 5, op: 0.1 },
  { s: "for()", top: 6, left: 84, size: 1.1, rot: 6, op: 0.1 },
  { s: "map()", top: 70, left: 84, size: 1.1, rot: -5, op: 0.1 },
  { s: "&&||", top: 42, left: 4, size: 1.4, rot: 8, op: 0.11 },
  { s: "++i", top: 58, left: 70, size: 1.3, rot: -4, op: 0.1 },
  { s: "<T>", top: 20, left: 20, size: 1.6, rot: 0, op: 0.11 },
  { s: "()=>", top: 90, left: 12, size: 1.4, rot: 4, op: 0.11 },
  { s: "0b11", top: 32, left: 96, size: 1, rot: -3, op: 0.1 },
  { s: "cd ~", top: 76, left: 60, size: 1.1, rot: 3, op: 0.1 },
  { s: "grep", top: 48, left: 88, size: 1.1, rot: -6, op: 0.1 },
  { s: "curl", top: 14, left: 66, size: 1.1, rot: 5, op: 0.1 },
  { s: "JSON", top: 60, left: 6, size: 1.1, rot: -4, op: 0.1 },
  { s: "void", top: 26, left: 4, size: 1.2, rot: 6, op: 0.1 },
  { s: "0x7E", top: 80, left: 40, size: 1.1, rot: 0, op: 0.1 },
  { s: "</>", top: 54, left: 62, size: 1.5, rot: -8, op: 0.11 },
  // more math
  { s: "∮", top: 4, left: 8, size: 1.9, rot: 0, op: 0.1 },
  { s: "⊗", top: 92, left: 4, size: 1.8, rot: 0, op: 0.1 },
  { s: "∪", top: 36, left: 52, size: 1.7, rot: 0, op: 0.1 },
  { s: "∩", top: 42, left: 72, size: 1.7, rot: 0, op: 0.1 },
  { s: "⌊x⌋", top: 66, left: 48, size: 1.4, rot: 0, op: 0.1 },
  { s: "ℝ", top: 8, left: 96, size: 1.9, rot: 0, op: 0.1 },
  { s: "ℤ", top: 74, left: 20, size: 1.9, rot: 0, op: 0.1 },
  { s: "∈ℕ", top: 50, left: 96, size: 1.3, rot: 0, op: 0.1 },
  { s: "dx/dt", top: 18, left: 42, size: 1.1, rot: -4, op: 0.1 },
  { s: "α", top: 86, left: 24, size: 2, rot: 0, op: 0.1 },
  { s: "β", top: 24, left: 78, size: 2, rot: 0, op: 0.1 },
  { s: "γ", top: 70, left: 66, size: 2, rot: 0, op: 0.1 },
  { s: "δ", top: 44, left: 34, size: 1.9, rot: 0, op: 0.1 },
  { s: "χ²", top: 12, left: 88, size: 1.5, rot: 0, op: 0.1 },
  { s: "n!", top: 96, left: 68, size: 1.6, rot: 0, op: 0.1 },
  // more time
  { s: "⏰", top: 2, left: 74, size: 1.7, rot: 8, op: 0.1 },
  { s: "🕐", top: 88, left: 54, size: 1.6, rot: 0, op: 0.09 },
  { s: "00:00", top: 34, left: 8, size: 1.1, rot: 5, op: 0.1 },
  { s: "ms", top: 56, left: 24, size: 1.5, rot: -4, op: 0.1 },
  { s: "GMT+5", top: 78, left: 88, size: 1, rot: 4, op: 0.1 },
  { s: "Δt→0", top: 20, left: 58, size: 1.1, rot: -3, op: 0.1 },
  { s: "60s", top: 62, left: 92, size: 1.4, rot: 0, op: 0.1 },
  { s: "epoch", top: 6, left: 36, size: 1, rot: -4, op: 0.1 },
];
